...
import AddEventMember from './src/event/add_event_member';
...
const PixNavigation = StackNavigator(
  {
    ...
    AddEventMember: { screen: AddEventMember, navigationOptions: {title: 'Add Members', headerStyle:{backgroundColor: '#ede'}}},
